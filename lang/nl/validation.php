...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | De volgende taalregels bevatten de standaard foutmeldingen die door de
    | validator worden gebruikt. Sommige regels hebben meerdere varianten,
    | zoals de size-regels.
    |
    */
    ...
    'ascii' => 'Het veld :attribute mag alleen alfanumerieke tekens en symbolen van een byte bevatten.',
    ...
    'in_array_keys' => 'Het veld :attribute moet minimaal een van de volgende sleutels bevatten: :values.',
    ...
    'prohibited_unless' => 'Het veld :attribute is verboden tenzij :other in :values voorkomt.',
    ...
    |--------------------------------------------------------------------------
    |
    | Hier kun je aangepaste validatieberichten opgeven voor attributen met
    | de conventie "attribute.rule".
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | De volgende taalregels worden gebruikt om de attribute-placeholder te
    | vervangen door iets dat prettiger leesbaar is.
    |
    */
