...
type DesktopPublicBookingLayoutProps = {
    breadcrumbs: BreadcrumbItemType[];
    children: ReactNode;
    headerAction?: ReactNode;
};

export default function DesktopPublicBookingLayout({ breadcrumbs, children, headerAction }: DesktopPublicBookingLayoutProps) {
